...
- **🔴收口的悬停句也必须"应这张盘而生"，绝不许套用某个盘的专属句**：每张盘的收口都不同，要从【这个人自己的内核/痛/功课】里长出来。绝不要把某一句（如"去看看天会不会塌下来"——那是"怕不完美"那类盘的专属句）当成通用收口，硬接到内核完全不同的盘上（如讲"苦难与光/功课养人"的盘，接"天会不会塌"就完全跑串、莫名其妙）。收口句和前文内核必须是一回事。
